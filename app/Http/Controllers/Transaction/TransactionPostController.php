...
class TransactionPostController extends ApiController
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $transactionParameter = $request->only(["items", "id", "partnerId"]);
        ...
        $paymentAgainDelivery = new PaymentAgainDelivery(new TransactionId($transactionParameter["id"]), new PartnerId($transactionParameter["partnerId"]), new UserId($userId));
