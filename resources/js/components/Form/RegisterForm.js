...
const RegisterForm = (props) => {
    ...
    return <Formik initialValues={{ name: "", phone: "", email: "", direction: "", password: "" }} enableReinitialize={true} onSubmit={onSubmit} mapPropsToValues={() => {
                    ...
                    <Grid spacing={2} container={true}>
                        ...
                        <Grid item xs={12} md={6}>
                            <div className="form-group-horizontal">
                                ...
                                <div className="form-group-field">
                                    <div className="form-group-input-wrap">
                                        <Field name="email" type="text" className={`field ${errors.email && touched.email ? "is-invalid" : ""}`} placeholder="Precio del producto" />
                        ...
                        <Grid item xs={12}>
                            <div className="form-group-horizontal">
                                ...
                                <div className="form-group-field">
                                    <div className="form-group-input-wrap">
                                        <Field name="direction" className={`field ${errors.direction && touched.direction ? "is-invalid" : ""}`} />
                        ...
                        <Grid item xs={12}>
                            <div className="form-group-horizontal">
                                ...
                                <div className="form-group-field">
                                    <div className="form-group-input-wrap">
                                        <Field name="password" className={`field ${errors.passoword && touched.passoword ? "is-invalid" : ""}`} />
